...
$feedback = null;
if ($_SERVER['REQUEST_METHOD'] === 'POST' && !empty($_POST['questionnaire_submit'])) {
    $antworten = [];
...
<div class="container my-4" style="max-width:900px;">
    ...
    <form method="post" autocomplete="off">
        ...
        <?php endforeach; ?>
        <button type="submit" class="btn btn-success px-4" name="questionnaire_submit" value="1">Abschicken</button>
    </form>
</div>
